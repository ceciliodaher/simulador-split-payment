...
class ConfiguracaoSplitPayment {
    ...
    // Sincroniza com os setores definidos em configuracoes-setoriais
    sincronizarSetoresEspeciaisDoConfigSetoriais() {
        try {
    ...
    carregarConfiguracoes() {
        try {
            ...
            if (configSalva) {
                ...
                // Após carregar do localStorage, sincroniza com configurações-setoriais
                this.sincronizarSetoresEspeciaisDoConfigSetoriais();
                
                return true;
            }
            
            // Se não encontrou no localStorage, tenta sincronizar com configurações-setoriais
            this.sincronizarSetoresEspeciaisDoConfigSetoriais();
...
const SimuladorApp = {
    ...
    // Modificar o método inicializar para garantir que o dropdown seja inicializado
	inicializar: function() {
		...
		// Garantir que o dropdown de setores seja atualizado explicitamente
    ...
    inicializarConfiguracoesSetoriais: function() {
        ...
        if (typeof SimuladorApp.ConfiguracoesSetoriais !== 'undefined') {
            SimuladorApp.ConfiguracoesSetoriais.inicializar();
        } else {
            console.warn('Módulo ConfiguracoesSetoriais não encontrado.');
        }
    ...
    // Modificar o método aoMudarAba para garantir que o dropdown seja atualizado
	aoMudarAba: function(tabId) {
		...
		switch (tabId) {
			...
			case 'estrategias-mitigacao':
				// Inicializar aba estratégias
				this.inicializarAbaEstrategias();
				break;
			case 'simulacao-principal':
				// Atualizar explicitamente o dropdown de setores quando voltar à aba principal
    ...
    // Melhorar o método atualizarDropdownSetores para ser mais robusto
    ...
    configurarEventListeners: function() {
        ...
        if (btnSalvarConfiguracoes) {
            ...
            novoBtn.addEventListener('click', () => {
                ...
                // Recarregar os setores na interface após salvar configurações
