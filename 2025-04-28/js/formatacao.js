...
const FormatacaoHelper = {
	...
	// Adicionar ao objeto FormatacaoHelper
	/**
	 * Extrai valor numérico de uma string formatada (moeda ou percentual)
	 * @param {string} valorFormatado - String formatada
	 * @returns {number} - Valor numérico
	 */
	extrairValorNumerico: function(valorFormatado) {
		if (!valorFormatado) return 0;
		
		// Remove símbolos de moeda, percentual e espaços
		let valor = valorFormatado.replace(/[R$%\s]/g, '');
