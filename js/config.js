...
class ConfiguracaoSplitPayment {
     ...
     * @returns {number} Alíquota total em decimal
     */
    obterAliquotaTotal() {
     ...
     * @returns {number} Alíquota efetiva do setor em decimal
     */
     ...
     * @returns {number} Percentual de implementação em decimal
     */
    ...
    // Modificações necessárias no arquivo config.js

	/**
	 * Formata um valor como moeda brasileira - MODIFICADO
	...
	/**
	 * Formata um valor como percentual - MODIFICADO
...
// Adicionar no final do arquivo config.js
// Exportar a classe para uso com módulos ES6
export { ConfiguracaoSplitPayment };